...
let getUsersButton= document.getElementById('getusersbutton')as HTMLElement
let usersdiv= document.getElementById('getusersdiv')as HTMLElement
...
//Made a post request to JSONPLACEHOLDER POST API
